...
<div class="min-h-screen bg-[#f8fafc]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 to-violet-700 p-8 mb-8 shadow-2xl shadow-purple-900/20">
            <div class="absolute top-0 right-0 -mt-20 -mr-20 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
            <div class="absolute bottom-0 left-0 -mb-20 -ml-20 w-64 h-64 bg-purple-400/10 rounded-full blur-3xl"></div>
            ...
            <div class="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-3xl md:text-4xl font-extrabold text-white tracking-tight">Espace Radiologue</h1>
                        <p class="text-purple-50 mt-1 font-medium opacity-90 flex items-center gap-2">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right hidden sm:block">
                        <p class="text-xs text-purple-100 uppercase font-bold tracking-widest mb-1">Status Session</p>
                        <div class="flex items-center gap-2 text-white font-bold">
                            <span class="w-2.5 h-2.5 bg-fuchsia-400 rounded-full shadow-[0_0_8px_rgba(232,121,249,0.8)] animate-pulse"></span>
                            Connecté en tant que Radiologue
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <a href="{{ route('lab.radiologist.validation') }}" class="group bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                ...
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-black text-purple-600">{{ $completedToday }}</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    @foreach($workloadData as $data)
                        <div class="flex-1 flex flex-col items-center gap-3 group">
                            <div class="relative w-full flex flex-col justify-end h-full">
                                ...
                                <div class="w-full bg-purple-50 rounded-xl group-hover:bg-purple-100 transition-colors" style="height: {{ ($data['count'] / $maxCount) * 100 }}%">
                                    <div class="w-full h-full bg-gradient-to-t from-purple-500 to-purple-400 rounded-xl opacity-80 group-hover:opacity-100 transition-all shadow-lg shadow-purple-500/20"></div>
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-8">
                ...
                <div class="space-y-6">
                    @forelse($recentValidations as $validation)
                        <div class="flex items-start gap-4 p-3 rounded-2xl hover:bg-gray-50 transition-colors cursor-pointer border border-transparent hover:border-gray-100">
                            <div class="w-10 h-10 bg-purple-50 text-purple-600 rounded-xl flex-shrink-0 flex items-center justify-center font-bold text-xs">
                ...
                <a href="{{ route('lab.history') }}" class="mt-8 block w-full py-4 text-center text-gray-500 hover:text-purple-600 font-bold text-xs uppercase tracking-[0.2em] border-2 border-dashed border-gray-100 rounded-2xl hover:border-purple-200 transition-all">
